...
describe('Chapter 5: Bit Manipulation -', () => {
  ...
  describe('flipBitToWin', () => {
    it('returns the longest sequence of 1\'s that can be generated by flipping one bit from 0 to 1', () => {
      ...
      expect(flipBitToWin(110111100)).to.be.equal(7)
    })

    it('returns the number of 1\'s in a sequence if a given sequence contains all 1\'s', () => {
      expect(flipBitToWin(111111111111)).to.be.equal(12)
      expect(flipBitToWin(1111111111)).to.be.equal(10)
      expect(flipBitToWin(11111111)).to.be.equal(8)
    })

    it('returns 0 if a sequence contains all 0\'s', () => {
      expect(flipBitToWin(000000000000)).to.be.equal(0)
      expect(flipBitToWin(0000000000)).to.be.equal(0)
      expect(flipBitToWin(00000000)).to.be.equal(0)
    })
  })
})
